...
<body>
    ...
    <div class="tools-container" id="home">
        <a href="/" class="hovering"><img src="img/logo-techmarket.png" alt="logo-brand" /></a>
        <p class="tech">Tech<span class="market"> Market</span></p>
        <svg class="profile-icon" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor"
    ...
    <section class="container">
        <div class="row flex-lg-row align-items-center g-5 py-5">
                ...
                <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item">
                            <img src="img/dxracer-drifting-oh-dh73-nc-3.jpg" class="d-block mx-lg-auto img-fluid"
                                alt="gambar product" width="700" height="500" loading="lazy">
                        </div>
                        <div class="carousel-item active">
                            <img src="img/DXRacer-DRIFTING-SERIES.png" class="d-block mx-lg-auto img-fluid"
                                alt="gambar product" width="700" height="500" loading="lazy">
                        </div>
                        <div class="carousel-item">
                            <img src="img/OIP.jpeg" class="d-block mx-lg-auto img-fluid" alt="gambar product"
            ...
            <div class="col-lg-6">
                ...
                <p class="lead">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Incidunt dolorem error ut
                    eaque minima debitis repellat, numquam obcaecati aspernatur, impedit ipsa nobis veritatis molestias
                    quam maxime magni tempore porro mollitia delectus saepe quis illo praesentium! Distinctio ea
                    corporis et ex provident! Impedit provident harum placeat, dolores numquam eveniet iusto hic!</p>
        ...
        <div class="row featurette align-items-center">
            <div class="col-md-7 d-flex align-items-center">
                ...
                <div class="row">
                    ...
                    <p>Bagus bangettt, sesuai dengan ekspektasi!!</p>
                </div>
            </div>
            <div class="col-md-5">
        ...
        <div class="row featurette align-items-center">
            <div class="col-md-7 d-flex align-item-center">
                ...
                <div class="row">
                    ...
                    <p>Udah pake kulit buaya, busa empuk dan semoga awet tidak gampang lembek, fitur udh mantep bgt ini, enak dipake 24/7 ngoding</p>
                </div>
            </div>
            <div class="col-md-5">
                <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
